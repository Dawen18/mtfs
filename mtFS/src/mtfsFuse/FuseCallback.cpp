...
namespace mtfsFuse {
	...
	struct fuse_lowlevel_ops FuseCallback::ops =
			{
					FuseCallback::init,
					FuseCallback::destroy,
					FuseCallback::lookup,
					FuseCallback::forget,
					FuseCallback::getAttr,
					FuseCallback::setattr,
					FuseCallback::readlink,
					FuseCallback::mknod,
					FuseCallback::mkdir,
					FuseCallback::unlink,
					FuseCallback::rmdir,
					FuseCallback::symlink,
					FuseCallback::rename,
					FuseCallback::link,
					FuseCallback::open,
					FuseCallback::read,
					FuseCallback::write,
					FuseCallback::flush,
					FuseCallback::release,
					FuseCallback::fsync,
					FuseCallback::opendir,
					FuseCallback::readdir,
					FuseCallback::releasedir,
					FuseCallback::fsyncdir,
					FuseCallback::statfs,
					FuseCallback::setxattr,
					FuseCallback::getxattr,
					FuseCallback::listxattr,
					FuseCallback::removexattr,
					FuseCallback::access,
					FuseCallback::create,
					FuseCallback::getlk,
					FuseCallback::setlk,
					...
					FuseCallback::ioctl,
					FuseCallback::poll,
					FuseCallback::write_buf,
					FuseCallback::retrive_reply,
					FuseCallback::forget_multi,
					FuseCallback::flock,
					FuseCallback::fallocate,
					FuseCallback::readdirplus,
			};
